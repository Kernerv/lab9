...
public class Student extends Human {
    ...
    public Student(String surname, String name, String midleName, int age, Gender gender, String university, String faculty, String speciality) {
        super(surname, name, midleName, age, gender);
